...
class wf_allImpExpCsv_Settings {
    ...
    public static function save_settings() {
        ...
        $sbc_ftp_port = !empty($_POST['sbc_ftp_port']) ? $_POST['sbc_ftp_port'] : 21;
        ...
        $cpn_ftp_port = !empty($_POST['cpn_ftp_port']) ? $_POST['cpn_ftp_port'] : 21;
        ...
        $ord_ftp_port = !empty($_POST['ord_ftp_port']) ? $_POST['ord_ftp_port'] : 21;
        $ord_use_ftps = !empty($_POST['ord_use_ftps']) ? true : false;
        $ord_ftp_path = !empty($_POST['ord_ftp_path']) ? $_POST['ord_ftp_path'] : '/';
        ...
        $xml_ftp_port = !empty($_POST['xml_ftp_port']) ? $_POST['xml_ftp_port'] : 21;
        ...
        $ord_auto_export_ftp_file_name = !empty($_POST['ord_auto_export_ftp_file_name']) ? $_POST['ord_auto_export_ftp_file_name'] : null;
        ...
        $ord_auto_import_file = !empty($_POST['ord_auto_import_file']) ? $_POST['ord_auto_import_file'] : null;
        $ord_auto_import_delimiter = !empty($_POST['ord_auto_import_delimiter']) ? $_POST['ord_auto_import_delimiter'] : ',';
