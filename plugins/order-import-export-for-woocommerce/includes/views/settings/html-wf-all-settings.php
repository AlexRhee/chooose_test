...
//For Order Test FTP 
$xa_ordr_all_piep_ftp = array('admin_ajax_url' => admin_url('admin-ajax.php'));
    ...
    <form action="<?php echo admin_url('admin.php?page=wf_woocommerce_order_im_ex&action=settings'); ?>" method="post">
        ...
        <table class="form-table">
            ...
            <table class="form-table" id="ord_export_section_all">
                ...
                <tr>
                    <th>
                        <label for="ord_auto_export_ftp_file_name"><?php _e('Export Filename', 'wf_csv_import_export'); ?></label>
                    </th>
                    <td>
                ...
                <tbody class="ord_import_section">
                    <tr>
                        ...
                        <td>
                            ...
                            <p style="font-size: 12px"><?php _e('Complete CSV path including name.', 'wf_order_import_export'); ?></p>
                        </td>
                    </tr>
